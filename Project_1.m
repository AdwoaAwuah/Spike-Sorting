...
close all
load('C:\Users\use\Desktop\Neural Engineering Projects\Matlab code\04.mat') %load waveform
...
% Using the output of Kmeans, plot the waveforms of the three clusters with
% different colors.
